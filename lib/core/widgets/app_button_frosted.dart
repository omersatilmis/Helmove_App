...
class AppFrostedButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDark 
        ...
        : const Color(0xB3FFFFFF); // Light: %70 Beyaz (Sütlü Buzlu Cam)

    // Çerçeve (Border) Rengi
    final borderColor = isDark 
        ? const Color.fromARGB(174, 255, 255, 255)  // Dark: %40 Beyaz (Net görünen beyaz çizgi)
        : const Color.fromARGB(185, 24, 23, 23); // Light: %10 Siyah (Kibar gri çizgi)

    // İkon Rengi
    final iconColor = isDark 
        ? Colors.white             // Dark: Beyaz İkon
