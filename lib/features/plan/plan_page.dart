...
import 'package:flutter_application_1/features/plan/widgets/premium_plan_card.dart';
import 'package:flutter_application_1/features/plan/widgets/plan_tab_selector.dart';
import 'package:flutter_application_1/core/widgets/app_button_frosted.dart'; // 👈 Import burada
...
class _PlanPageState extends State<PlanPage> {
  ...
  final List<PlanModel> _plans = [
    PlanModel(
      ...
      period: "/sonsuza dek",
      productId: "free",
      features: ["Harita Erişimi", "Grup Sürüşlerine Katıl", "Reklamlı Deneyim"],
    ...
    PlanModel(
      ...
      features: ["Tüm Ücretsiz Özellikler", "Reklamsız Deneyim", "Sınırsız Rota Kaydı", "Canlı Konum (Ghost Mode)"],
    ...
    PlanModel(
      ...
      features: ["Tüm Pro Özellikler", "Özel Kulüp Rozeti", "Etkinlik Oluşturma", "İnterkom Özelliği (Beta)"],
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return AnimatedScale(
                        ...
                        child: PremiumPlanCard(
                          ...
                          onBuyTap: () {
                             print("Satın al: ${plan.title} (${plan.productId})");
                          },
                        ),
                      );
                    },
