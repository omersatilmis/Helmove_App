          ...
          return Stack(
            children: [
              ...
              AnimatedPositioned(
                ...
                curve: Curves.easeInOutCubic, // Yumuşak ve havalı bir geçiş eğrisi
                left: currentIndex * tabWidth, // Hangi sıradaysa o kadar sağa kaydır
                top: 0,
                bottom: 0,
                width: tabWidth,
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: plans[currentIndex].gradientColors,
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: plans[currentIndex].gradientColors.first.withValues(alpha: 0.3),
                        blurRadius: 8,
