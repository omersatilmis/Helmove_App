...
import 'package:flutter_application_1/features/settings/widgets/account_section.dart';
import 'package:flutter_application_1/features/settings/widgets/app_experience_section.dart';
import 'package:flutter_application_1/features/settings/widgets/app_settings_section.dart';
import 'package:flutter_application_1/features/settings/widgets/privacy_section.dart';
import 'package:flutter_application_1/features/settings/widgets/support_section.dart';
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    SupportSection(),
                    SizedBox(height: 40), // Alt boşluk (Bottom Navigation payı vs.)
                  ],
                ),
              ),
            ),
