...
import 'package:flutter_application_1/features/settings/widgets/helper_widgets.dart'; // 🔥 Helper'ı dahil ettik
    ...
    return Column(
      ...
      children: [
        ...
        SettingsSelectionTile(
          ...
          options: const ["Herkes", "Sadece Arkadaşlar", "Gizli (Kimse Göremez)"],
          onSelect: (val) {
