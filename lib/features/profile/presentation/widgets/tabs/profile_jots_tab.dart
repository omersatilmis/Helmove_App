...
import 'package:moto_comm_app_1/features/profile/presentation/widgets/tabs/jots/jots_widget.dart';
// Yeni sayfan
  ...
  final List<Map<String, String>> _jots = [
    {
      ...
      "content":
          "Hafta sonu rotası belli mi beyler? Teker dönsün! 🏍️💨 #motolife",
      "time": "2h",
    },
    {
      "firstName": "Marcus",
      ...
      "userName": "marcusteanly",
      "content":
          "Yeni rotalar keşfetmek için sabırsızlanıyorum. Belgrad ormanı tarafı sakin midir?",
      "time": "5h",
    },
  ];
