...
import 'package:flutter_application_1/app/bottom_bar.dart';
import 'package:flutter_application_1/features/auth/login_page.dart';
import 'package:flutter_application_1/features/auth/register_page.dart';

// 🔥 YENİ SAYFALARIN IMPORTLARI
import 'package:flutter_application_1/features/homepage/home_page.dart';
import 'package:flutter_application_1/features/discover/discover_page.dart';
import 'package:flutter_application_1/features/addpost/add_post_page.dart';
import 'package:flutter_application_1/features/map/map_page.dart';
import 'package:flutter_application_1/features/communication/communication_page.dart';

// Drawer Sayfalarının Importları
import 'package:flutter_application_1/features/profile/profile_page.dart';
import 'package:flutter_application_1/features/plan/plan_page.dart';
import 'package:flutter_application_1/features/communities/communities_page.dart'; 
import 'package:flutter_application_1/features/settings/settings_page.dart';  
import 'package:flutter_application_1/features/help/help_page.dart';

// Homepage den girilen sayfaların Importları
import 'package:flutter_application_1/features/messages/messages_page.dart';
import 'package:flutter_application_1/features/notification/notification_page.dart';

// Profile Jots Tabından açılan sayfa
import 'package:flutter_application_1/features/profile/widgets/tabs/jots/create_jots.dart';
...
final router = GoRouter(
  ...
  routes: [
    ...
    // Profile Jots Tabından açılan sayfa
    GoRoute(path: '/create_jots', builder: (context, state) => const CreateJotsPage()),
